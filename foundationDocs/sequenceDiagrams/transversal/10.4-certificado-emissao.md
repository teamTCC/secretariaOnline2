...
sequenceDiagram
  ...
  ISS->>Outbox: OutboxEventPublisher.enqueue(certificate.issued)
  ISS->>PG: COMMIT
```
...
- Passos 7–10: TX atômica — `certificate` inserido e `OutboxEventPublisher.enqueue` na mesma TX; se o COMMIT falhar, nenhum certificado é registrado e o outbox não é enfileirado.
